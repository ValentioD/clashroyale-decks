<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Voorbeeld extra link naar Decks (optioneel) --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    ...
                    <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-600 dark:text-gray-300 hover:underline">
                        {{ __('Register') }}
                    </a>
                @endguest
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <!-- Responsive instellingen opties -->
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @guest
                <div class="px-4">
                    <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ __('Gast') }}</div>
